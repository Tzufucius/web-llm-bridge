...
class ArtifactTransferTests(unittest.TestCase):
    def test_chunk_sequence_and_size_are_validated(self) -> None:
        transfer = {"expected": None, "mime_type": None, "next_sequence": 0, "data": bytearray(), "error": None, "done": asyncio.Event()}
    ...
    def test_duplicate_sequence_is_rejected(self) -> None:
        transfer = {"expected": 2, "mime_type": "image/png", "next_sequence": 1, "data": bytearray(b"a"), "error": None, "done": asyncio.Event()}
